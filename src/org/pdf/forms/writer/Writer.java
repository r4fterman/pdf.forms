        ...
        for (Iterator iter = widgets.iterator(); iter.hasNext(); ) {
            ...
            switch (type) {
                ...
                case IWidget.RADIO_BUTTON: {
                    /** these are handled seperately at the begining */
                    break;
                }
...
//    }
    ...
    private void addImage(IWidget widget, Rectangle pageSize, int currentPage) {
        ...
        cb.saveState();
        cb.concatCTM(1, 0, 0, 1, pdfValueBounds.left(), pdfValueBounds.top() - imageBounds.height);
...
//        cb.restoreState();
    ...
    private Rectangle convertJavaCoordsToPdfCoords(java.awt.Rectangle bounds, Rectangle pageSize) {
        ...
        float pdfY1 = pageSize.height() - javaY1 - bounds.height;

    ...
    private void addMenuItemMain(String name, int command, JMenu menu) {
        switch (command) {
            ...
            case Commands.BRING_TO_FRONT:
                alignAndOrderMenuItems.add(addAlignAndOrderMenuItems(name, WidgetAlignmentAndOrder.BRING_TO_FRONT, "/org/pdf/forms/res/Bring to Front.gif", menu));
                break;
            case Commands.SEND_TO_BACK:
                alignAndOrderMenuItems.add(addAlignAndOrderMenuItems(name, WidgetAlignmentAndOrder.SEND_TO_BACK, "/org/pdf/forms/res/Send to Back.gif", menu));
                break;
            case Commands.BRING_FORWARDS:
                alignAndOrderMenuItems.add(addAlignAndOrderMenuItems(name, WidgetAlignmentAndOrder.BRING_FORWARDS, "/org/pdf/forms/res/Bring Forwards.gif", menu));
                break;
            case Commands.SEND_BACKWARDS:
                alignAndOrderMenuItems.add(addAlignAndOrderMenuItems(name, WidgetAlignmentAndOrder.SEND_BACKWARDS, "/org/pdf/forms/res/Send Backwards.gif", menu));
                break;

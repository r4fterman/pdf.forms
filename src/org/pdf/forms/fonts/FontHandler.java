...
public class FontHandler {
    ...
    private String[] fontDirectories = new String[]{"c:/windows/fonts", "c:/winnt/fonts", "d:/windows/fonts",
            "d:/winnt/fonts", "/usr/X/lib/X11/fonts/TrueType", "/usr/openwin/lib/X11/fonts/TrueType",
            "/usr/share/fonts/default/TrueType", "/usr/X11R6/lib/X11/fonts/ttf", "/Library/Fonts",
            "/System/Library/Fonts", javaFontDir};

    private FontHandler() {
        for (int i = 0; i < fontDirectories.length; i++) {
            String dir = fontDirectories[i];
    ...
    /**
     * todo adapt this method to handle a duff file, behave nicely, and tell any method that relies on it what happened
     */

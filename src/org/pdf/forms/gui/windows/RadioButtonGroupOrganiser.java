...
public class RadioButtonGroupOrganiser extends javax.swing.JPanel {
     ...
     */
    public RadioButtonGroupOrganiser(JDialog parentDialog, List radioButtonGroups, List widgetsOnPage, int type) {
    ...
    private void renameClicked(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_renameClicked
    ...
    }//GEN-LAST:event_renameClicked

    private void removeClicked(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeClicked
        Object selectedItem = buttonGroupsList.getSelectedValue();
        if (selectedItem != null) {

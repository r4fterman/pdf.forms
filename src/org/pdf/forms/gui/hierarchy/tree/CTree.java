...
public class CTree extends JTree implements DragSourceListener, DragGestureListener, Autoscroll {
    ...
    /**
     * Autoscroll Interface... The following code was borrowed from the book: Java Swing By Robert Eckstein, Marc Loy &
     * Dave Wood Paperback - 1221 pages 1 Ed edition (September 1998) O'Reilly & Associates; ISBN: 156592455X <p/> The
     * relevant chapter of which can be found at: http://www.oreilly.com/catalog/jswing/chapter/dnd.beta.pdf
     */

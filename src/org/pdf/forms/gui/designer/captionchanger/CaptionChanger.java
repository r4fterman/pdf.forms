...
public class CaptionChanger {
    ...
    public void displayCaptionChanger(IWidget selectedWidget, IDesigner designerPanel) {
        ...
        captionText = correctLineBreaksFromHtml(captionText);
    ...
    private void setCaptionText() {
        ...
        captionText = "<html>" + alignment + correctLineBreaksToHtml(captionText);
    ...
    String correctLineBreaksToHtml(String captionText) {
        return captionText.replaceAll("\n", "<br>");
    }

    String correctLineBreaksFromHtml(String captionText) {
        return captionText.replaceAll("<br>", "\n");
    }
